...
|Developer Platform | Windows 10 or Ubuntu 20.04 |
|Azure SDK | Azure Sphere SDK 21.07 or better |
...
[Azure Sphere](https://azure.microsoft.com/services/azure-sphere/?WT.mc_id=iot-0000-dglover) is a unique highly secure IoT platform. You focus on your solution, Azure Sphere manages security, identity, certificates, reporting, tracking emerging attack vectors, mitigating, updating the platform, and application distribution to protect your solutions, customers, and reputations.
