...
DX_DEVICE_TWIN_BINDING *device_twin_bindings[] = {&dt_hvac_temperature,        &dt_hvac_pressure,   &dt_hvac_humidity, &dt_hvac_operating_mode,
                                                  &dt_hvac_target_temperature, &dt_hvac_sw_version, &dt_hvac_start_utc};
